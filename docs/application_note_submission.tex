...
\address[6]{\orgdiv{Institute of Advanced Intelligence and Computing (IAIC)}, \orgname{Agency for Science, Technology and Research}, \orgaddress{\street{Singapore}, \postcode{138632}, \country{Singapore}}}
...
% \address[]{\orgdiv{Shenzhen Branch, Guangdong Laboratory of Lingnan Modern Agriculture}, \orgname{Agricultural Genomics Institute at Shenzhen, Chinese Academy of Agricultural Sciences}, \orgaddress{\street{Shenzhen}, \postcode{518120}, \country{China}}}
...
TPSGen was assessed as a reproducible software workflow rather than as a new machine-learning benchmark. We used a fixed demonstration set of 40 tomato promoter sequences of 165 bp, generated three candidates per input with a fixed seed and retained the complete output manifest. This run was designed to demonstrate reproducible execution and output interpretation, not to estimate population-level performance.
