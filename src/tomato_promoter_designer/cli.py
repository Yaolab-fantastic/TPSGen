...
from tomato_promoter_designer.resources import find_example, find_model
...
def main(argv: list[str] | None = None) -> int:
    ...
    if args.command == "extract-promoters":
        ...
        from tomato_promoter_designer.preprocessing.extract_promoters import extract_gene_promoters
    ...
    if args.command == "validate-dnabert":
        from tomato_promoter_designer.legacy.dnabert_motif import validate_dnabert_resources
    ...
    if args.command == "validate-models":
        from tomato_promoter_designer.resources import repository_root
    ...
    if args.command == "predict-transvae":
        try:
            from tomato_promoter_designer.pipeline.predict_transvae import (
